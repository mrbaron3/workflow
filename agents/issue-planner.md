...
2. For each issue write a full Issue Contract (see templates/issue-contract.md):
   product goal, user story, explicit scope include/exclude, acceptance criteria, red lines.
