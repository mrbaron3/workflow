...
import { z } from 'zod';
import capabilityRequirementsJsonSchema from '../../internal/designgate/schemas/capability-requirements.schema.json' with { type: 'json' };
import commonJsonSchema from '../../internal/designgate/schemas/common.schema.json' with { type: 'json' };
import designRequestJsonSchema from '../../internal/designgate/schemas/design-request.schema.json' with { type: 'json' };
import designSystemDeltaJsonSchema from '../../internal/designgate/schemas/design-system-delta.schema.json' with { type: 'json' };
import experienceContractJsonSchema from '../../internal/designgate/schemas/experience-contract.schema.json' with { type: 'json' };
import {
