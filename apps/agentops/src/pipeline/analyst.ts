...
const REPAIR_BRIEF_FIDELITY_DRAFT: IssueContract = {
  ...
  scope: {
    include: [
      'apps/agentops/src/pipeline/repair.ts',
      'apps/agentops/src/domain/artifact.ts',
      'apps/agentops/test/**',
    ],
    exclude: ['apps/agentops/test/acceptance-harness/**'],
  },
  acceptanceCriteria: [
    {
      id: 'AC-1',
