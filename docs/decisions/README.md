...
| [ADR-0012](ADR-0012-external-designflow-provider.md) | UX/UI設計をDesignflowへ分離し、digest-boundな人間承認後にbackend capabilityを最終計画へ戻す | 採択・吸収済み（契約bootstrap済み、adapter未実装） |
