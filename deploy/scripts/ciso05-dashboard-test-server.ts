...
import { Pool } from 'pg';
import { migrateControlSchema } from '../../apps/agentops/src/control-store/index.js';
...
const child = spawn('go', ['run', './apps/control-plane/cmd/agentops-control'], {
  cwd: REPOSITORY_ROOT,
  env: {
    ...process.env,
    AGENTOPS_APP_ROOT: REPOSITORY_ROOT,
